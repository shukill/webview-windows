...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
        navigatorKey: navigatorKey, home: const ExampleBrowser());
  }
}
...
class _ExampleBrowser extends State<ExampleBrowser> {
  ...
  Future<void> initPlatformState() async {
    ...
    try {
      ...
      // Set initial scale
      final String script =
          'document.querySelector(\'meta[name="viewport"]\')?.setAttribute("content", "width=$width, height=$height, initial-scale=$scale");';
